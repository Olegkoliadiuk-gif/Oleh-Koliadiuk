...
alert(userEmpty.address && userEmpty.address.street && userEmpty.address.street.name);
...
let htmlBad = document.querySelector(".elem") ? document.querySelector(".elem").innerHTML : null;
